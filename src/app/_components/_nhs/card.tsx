    ...
    <div className="nhsapp-card">
      <div className="nhsapp-card__container">
        <div className="nhsapp-card__content">
          <a href="#" className="nhsapp-card__link nhsuk-link--no-visited-state">
            {cardProps.title}
          </a>
        </div>
        <svg className="nhsapp-icon nhsapp-icon__chevron-right" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" height="2rem" width="2rem" viewBox="0 0 24 24">
          <path
