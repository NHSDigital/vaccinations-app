...
const FeedbackBanner = ({ referrer }: FeedbackBannerProps) => {
  return (
    <div className={`nhsuk-grid-row container ${styles.feedbackBannerContainer}`}>
      <p className="nhsuk-body-s nhsuk-u-margin-bottom-0">
        This is a new NHS App service. Help us improve it and{" "}
        <a className="nhsuk-link--no-visited-state" href={`${baseFeedbackUrl}?page=${referrer}`} target="_blank">
          give your feedback
        </a>
        .
      </p>
