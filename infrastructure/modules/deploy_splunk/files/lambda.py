# Taken from https://github.com/ptdavies17/CloudwatchFH2HEC/blob/master/Cloudwatch2FH2HECv2.py
...
def transformLogEvent(log_event,acct,arn,loggrp,logstrm,filterName):
    ...
    # Modified original code snippet to be more readable and included filter name, log group, and log stream as fields
    try:
        parsed_message = json.loads(log_event["message"])
    except (ValueError, TypeError):
        parsed_message = log_event["message"]
